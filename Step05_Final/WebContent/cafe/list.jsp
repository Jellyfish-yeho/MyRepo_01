...
<%
	...
	*/
	...
	//CafeDto 객체에 startRowNum, endRowNum을 담는다.
...
<body>
	...
	<a href="private/insertform.jsp">new post</a>
			...
			<tbody>
				<%for(CafeDto tmp:list){%>
					<tr>
						...
						<td><%=tmp.getWriter() %></td>
						<td>
							<a href="detail.jsp?num=<%=tmp.getNum()%>&condition=<%=condition %>&keyword=<%=encodedK%>"><%=tmp.getTitle() %></a>
						</td>
