...
<body>
	...
	<div class="container mt-4">
		<h1 class="p-3 mb-2 bg-primary text-white">Modify your to-do.</h1>
		<%
			request.setCharacterEncoding("utf-8");
			//회원번호 파라미터 읽어와서 (num) 해당 회원정보 읽어오기 (select dto)
			//get 방식 파라미터로 전달되는 수정할 할일의 번호를 읽어온다. 
			int num=Integer.parseInt(request.getParameter("num"));
			//TodoDao 객체를 이용해서 할일 정보를 얻어온다. 
			TodoDto dto=TodoDao.getInstance().getData(num);
		%>
		<form class="mt-4" action="<%=request.getContextPath()%>/todo/update.jsp" method="post">
			<div>
				<p>
