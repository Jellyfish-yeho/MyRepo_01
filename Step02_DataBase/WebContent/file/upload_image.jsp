...
<%
   ...
   // <input type="text" name="comment" /> 에 입력한 문자열 읽어오기
   String comment = mr.getParameter("comment");
   // <input type="file" name="myFile" /> 을 통해서 업로드된 파일을 access 할 수 있는 File 객체로 읽어오기
